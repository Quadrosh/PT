...
<div class="phone-form ">
    ...
    <?= $form->field($preorder, 'type',['template' => '{input}', 'options' => ['tag' => false]])
        ->hiddenInput(['value'=>Feedback::TYPE_TO_MASTER,
            'id' => 'quickorder-form-section'.$section->id.'-type'])
        ->label(false) ?>
