...
/**
 * ArticleSectionSearch represents the model behind the search form about `common\models\ArticleSection`.
 */
class ArticleSectionSearch extends ArticleSection
{
    /**
     * @inheritdoc
     */
    ...
    {
        return [
            [['id', 'article_id', 'created_at', 'updated_at'], 'integer'],
